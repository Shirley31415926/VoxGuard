...
async function startSensors() {
  ...
  try {
    ...
    elements.speechDot.classList.add("live");
    elements.phaseTitle.textContent = "Sensors active";
    elements.phaseInstruction.textContent = "Record a normal baseline or start the guided FAST check.";
    setResult("neutral", "Ready for guided check", "Raw media is processed locally in this browser and is not uploaded by this demo.");
    resizeCanvas();
    renderLoop();
  } catch (error) {
    console.error(error);
